...
public class MessageConstants {
	...
	public static final String UPDATE__EQIPMENT_SUCCESS_MESSAGE = "Equipment updated successfully";
	public static final String UPDATE__EQIPMENT_ERROR_MSG = "Unable to update Equipment";
